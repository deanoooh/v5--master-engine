...
tab1, tab2, tab3 = st.tabs([" 7-Race Processing", " P&L & Audit", " Database Management"])
...
with tab1:
 ...
 st.warning("Field Size: Win-Only Enforced (< 8 Runners)")
...
# Navigation Tabs
tab1, tab2, tab3 = st.tabs([" P&L & Performance Audit", " Log New Selections", " Database Management"])
